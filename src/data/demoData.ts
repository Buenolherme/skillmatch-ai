...
João Silva`,
  ...
  proofCheck: [
    { skill: 'React', status: 'proven', evidence: 'Task Manager App, E-commerce Dashboard', message: 'React está comprovado em 2 projetos documentados.' },
    { skill: 'TypeScript', status: 'proven', evidence: 'Task Manager App', message: 'TypeScript está comprovado no projeto Task Manager.' },
    { skill: 'JavaScript', status: 'proven', evidence: 'Todos os projetos', message: 'JavaScript está comprovado como base de todos os projetos.' },
    { skill: 'Git', status: 'proven', evidence: 'Curso DIO + GitHub ativo', message: 'Git está comprovado via curso e repositório ativo.' },
    { skill: 'Next.js', status: 'unproven', message: 'Next.js aparece nas habilidades, mas não há projeto ou experiência comprovando essa competência.' },
    { skill: 'Testes unitários / Jest', status: 'missing', message: 'Testes unitários são requisito da vaga, mas não aparecem em nenhum projeto do currículo.' },
    { skill: 'Figma', status: 'unproven', message: 'Figma está listado como "básico", mas não há projeto de design ou prototipagem que comprove uso.' },
    { skill: 'Node.js', status: 'unproven', message: 'Node.js aparece no projeto mas não há descrição clara de como foi usado no back-end.' },
  ],
  improvementPlan: [
